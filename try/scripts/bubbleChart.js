...
//Read the data
// d3.csv("https://gist.githubusercontent.com/ycfan14/4fef7870170210b388f886d216e625d3/raw/7ebacdc5bb3c17e09cf848580e537a529ad7e4a6/gistfile1.txt", function(data) {
...
d3.csv("https://gist.githubusercontent.com/ycfan14/9b8e0e7639bcb2769caaf6e1797ef348/raw/ae77949f83e560f39c0082a47605ff73d4c0c6fb/trial_2010_nonUS.csv", function(data) {
    ...
    var x = d3.scaleLinear()
        .domain([0, d3.max(data, function(d) { return +d.inflow; })])
        .range([ 0, width ]);
    svg.append("g")
    ...
    var y = d3.scaleLinear()
        .domain([0, d3.max(data, function(d) { return +d.outflow; })])
        .range([height, 0]);
    svg.append("g")
        .call(d3.axisLeft(y));
    ...
    svg.append('g')
        ...
        .attr("cx", function (d) { return x(d.inflow); } )
        .attr("cy", function (d) { return y(d.outflow); } )
        .attr("r", function (d) { return z(d.stock); } )
