...
d3.csv("https://gist.githubusercontent.com/zhengyunhan/6bae5a5d7872ea314ca155281865fcc3/raw/820ee002c06751c4689e6f7a64318446cdd54fae/select_inflow.csv", function(Inflow){
    d3.csv("https://gist.githubusercontent.com/zhengyunhan/ec0cba9408754fc0b38ae90b4dd65a10/raw/3ff848f89d4ebd2ded2c698f1697e18c9a4c3afa/select_outflow.csv", function(Outflow){
...
var selected_institution = e.options[e.selectedIndex].value;

    selected_inflow=Inflow.filter(r => r[selected_institution] == 1);
    selected_outflow=Outflow.filter(r => r[selected_institution] == 1);
